      ...
      <div className="history1980">
        ...
        <div className="history1980Info">
          ...
          <div className="history1980Text">
            ...
            The franchise has its roots in a gaming magazine in the early 1980s
            in Japan—Game Freak, started by Satoshi Tajiri and Ken Sugimori.
            Tajiri was the writer, while Sugimori was the illustrator.
          </div>
        </div>
      </div>
      ...
      <div className="history1998">
        ...
        <div className="history1998Info">
          ...
          <div className="history1998Text">
            ...
            Monsters’ success led to North America getting the games in 1998 for
            the Game Boy (as Pokémon Red and Blue). These few years in the
